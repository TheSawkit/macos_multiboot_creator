...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "fr": {
        ...
        "disk.volume_found": "Volume trouvé avec le nom attendu: {expected_path}",
        "disk.volume_found_expected_name": "Volume trouvé par nom attendu: {vol_path}",
        ...
        "disk.partition_success_validate": "\n✅ Validation réussie: {total_needed_gb:.2f} GB nécessaires pour les partitions fixes,\n{disk_size_gb:.2f} GB disponibles",
        "disk.partition_fail_validate": "\n❌ Impossible de valider les tailles de partitions: {error}",
        ...
        "disk.partition_success": "\n✅ Succès du partitionnement",
        "disk.partition_error_details": "\n   Erreur : {details}",
        "disk.remaining_space_fail": "\n❌ Impossible de calculer l'espace restant : {error}",
        # installer/finder.py
        ...
        "installer.space_needed": "Espace total nécessaire: {total_needed_bytes / BYTES_PER_GB:.2f} GB",
        # installer/media.py
        ...
        "install_media.volume_found": "Volume réel trouvé: {vol_path}",
        ...
        "install_media.volume_standard_warning": "⚠️ Structure du volume {vol_path} non standard, mais taille acceptable:\n{total_size / (1024*1024):.1f} MB. Fichiers: {items[:5]}",
    ...
    "en": {
        ...
        "disk.volume_found": "Volume found with the expected name: {expected_path}",
        ...
        "disk.partition_fail_validate": "\n❌ Unable to validate partition sizes: {error}",
        ...
        "installer.space_needed": "Total space required: {total_needed_bytes / BYTES_PER_GB:.2f} GB",
        # installer/media.py
        ...
        "install_media.volume_found": "Actual volume found: {vol_path}",
        ...
        "install_media.volume_standard_warning": "⚠️ Volume structure {vol_path} is non-standard, but size is acceptable:\n{total_size / (1024*1024):.1f} MB. Files: {items[:5]}",
